  ...
  <div class="grafico-setor">
    ...
    <div class="area">
      ...
      <div class="caixa-icones">
        <btn classes="teal darken-2 btn-arrow borda" frase="" evento="anterior" modo="icone" icone="fas fa-arrow-left" :show="true" @anterior="mudar(-1)"/>
        <btn classes="teal darken-2 btn-arrow borda" frase="" evento="proximo" modo="icone" icone="fas fa-arrow-right" :show="true" @proximo="mudar(1)"/>
        <btn classes="btn-zoom blue lighten-2 borda" frase="" evento="zoom" modo="icone" icone="fas fa-search-plus" @zoom="zoom()" :show="zoomBtn" /></div>
      </div>
     <div>
...
export default {
  ...
  methods: {
      ...
      options.xAxis = [
        {
            type: 'category',
            axisTick: {show: false},
            data: valores.map((valor,index) => {return index + 1})
        }
    ],
    options.yAxis = [
        {
    ...
    nomes(obj){
      ...
      const nomes = raw.map((valor) => {return valor.setor})
      console.log(nomes)
      return nomes
    }
  },
